...
CREATE TABLE ROLES (
	...
	role_createdon DATE NOT NULL,
	role_changedon DATE NOT NULL,
	PRIMARY KEY (role_ID),
);

INSERT INTO ROLES(role_ID, role_name, role_status, role_createdon, role_changedon) 
	VALUES(1,  'ADMINISTRATOR', 'True', @created, @changed)
INSERT INTO ROLES(role_ID, role_name, role_status, role_createdon, role_changedon) 
	VALUES(2,  'VENDOR', 'True', @created, @changed)
INSERT INTO ROLES(role_ID, role_name, role_status, role_createdon, role_changedon) 
	VALUES(3,  'CUSTOMER', 'True', @created, @changed)
INSERT INTO ROLES(role_ID, role_name, role_status, role_createdon, role_changedon) 
	VALUES(4,  'EMPLOYEE', 'True', @created, @changed)
INSERT INTO ROLES(role_ID, role_name, role_status, role_createdon, role_changedon) 
	VALUES(5,  'USER', 'True', @created, @changed)
...
INSERT INTO USERS(user_ID, user_contactID, user_roleID, user_name, user_password, user_email, user_firstName, user_lastName, user_status, user_createdon, user_changedon)
	VALUES(1, 16, 1,  'user_01', '@12345', 'user1gmail.com', 'usu�rio 01', 'Silva', 'True', @created, @changed)
INSERT INTO USERS(user_ID, user_contactID, user_roleID, user_name, user_password, user_email, user_firstName, user_lastName, user_status, user_createdon, user_changedon)
	VALUES(2, 17, 2,  'user_02', '@12345',  'user2gmail.com', 'usu�rio 02', 'Maciel', 'True', @created, @changed)
INSERT INTO USERS(user_ID, user_contactID, user_roleID, user_name, user_password, user_email, user_firstName, user_lastName, user_status, user_createdon, user_changedon)
	VALUES(3, 18, 3,  'user_03',  '@12345',  'user3gmail.com', 'usu�rio 03', 'Pereira', 'True', @created, @changed)
INSERT INTO USERS(user_ID, user_contactID, user_roleID, user_name, user_password, user_email, user_firstName, user_lastName, user_status, user_createdon, user_changedon)
	VALUES(4, 19, 4,  'user_04',  '@12345',  'user4gmail.com', 'usu�rio 04', 'Jaboticabal', 'True', @created, @changed)
INSERT INTO USERS(user_ID, user_contactID, user_roleID, user_name, user_password, user_email, user_firstName, user_lastName, user_status, user_createdon, user_changedon)
	VALUES(5, 20, 5,  'user_05',  '@12345',  'user5gmail.com', 'usu�rio 05', 'Petrovisk', 'True', @created, @changed)
